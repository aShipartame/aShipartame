The default code generated by "statcounter" is not compatible with al-folio deployed on github. The failure is caused by the "+" in the following lines:
```
document.write("<sc"+"ript type='text/javascript' src='" +
scJsHost+
"statcounter.com/counter/counter.js'></"+"script>");
```
It can be fixed by replacing the above lines with this line (use "concat" instead of "+"):
```
document.write("<sc".concat("ript type='text/javascript' src='",scJsHost,"statcounter.com/counter/counter.js'></","script>"));
```
